      ...
      <ul class="clear">
        ...
        <li class="active"><a class="drop" href="ergazomenos.php">Εργαζόμενος</a>
          <ul>
            ...
            <li class="active"><a href="lista_adeiwn.php">Λίστα αδειών ειδικού σκοπού</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <?php
        ...
        if ($parent != 'yes'){
          echo '<p>Πρέπει να είστε γονέας για να έχετε πρόσβαση σε αυτήν την σελίδα. Βεβαιωθείτε επίσης ότι έχετε συνδεθεί στην εφαρμογή.</p>';
        }else{
