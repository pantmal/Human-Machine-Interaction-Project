        ...
        <li><a class="drop" href="#">Εργαζόμενος</a>
          <ul>
            <li><a class="drop" href="#">COVID-19 και Εργασία</a>
              <ul>
                <li class="active"><a href="prev-measures.html">Μέτρα προστασίας στον χώρο εργασίας</a></li>
                <li><a href="antimetwpisi_krousmatos.html">Αντιμετώπιση κρούσματος στον χώρο εργασίας</a></li>
          ...
          <ul>
            <li><a class="drop" href="#">COVID-19 και Εργασία</a>
              <ul>
                ...
                <li class="active"><a href="#">Μέτρα προστασίας COVID-19</a></li>
                <li><a href="antimetwpisi_krousmatos.html?var=sth">Αντιμετώπιση κρούσματος</a></li>
              </ul>
            </li>
...
<div class="wrapper bgded overlay gradient" style="background-image:url('../images/demo/backgrounds/01.png');">
  <div id="breadcrumb" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <h6 class="heading">Μέτρα προστασίας</h6>
    <ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <h6> <b>Υπάρχει <a href="antimetwpisi_krousmatos.html"> κρούσμα στον εργασιακό σας χώρο; </a> </b></h6> <br>
