      ...
      <ul class="nospace">
        <?php 
          ...
          if(!isset($_COOKIE[$cookie_name])) {        
              echo '<li><a style="color: #0026ff" href="login.html?header=metra_prolipsis.php" title="Σύνδεση">Σύνδεση <i class="fas fa-sign-in-alt"></i></a></li>';
              echo '<li><a style="color: #0026ff" href="register.html?header=metra_prolipsis.php" title="Εγγραφή">Εγγραφή <i class="fas fa-edit"></i></a></li>';
          } else {
    ...
    <nav id="mainav" class="fl_right"> 
      ...
      <ul class="clear">
        <li class="active"><a class="drop" href="covid_19.php">COVID-19</a>
          <ul>
            <li class="active"><a href="metra_prolipsis.php">Μέτρα προστασίας στον χώρο εργασίας</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <h1> <b>Υπάρχει <a href="antimetwpisi_krousmatos.php"> κρούσμα στον εργασιακό σας χώρο; </a> </b></h1> <br>
    <h1> Ιατρικές Οδηγίες για την Πρόληψη της Διασποράς του Ιού</h1>
    <p>Επαναλαμβάνονται με εμφατικό τρόπο οι γενικές οδηγίες ατομικής υγιεινής και
    προστασίας. Η τήρηση τους μειώνει δραστικά τον κίνδυνο μετάδοσης του ιού:</p>
    <ul>
      <li>Φοράτε <b> παντού και πάντα </b> την μάσκα σας.</li>
      <li><b>Μην </b> ακουμπάτε την μάσκα σας με τα χέρια σας. Πιάστε μόνον τα λάστιχα
          για να την βάλετε και να την βγάλετε</li>
      <li>Αν βήξετε ή φταρνιστείτε, καλύψτε το στόμα και την μύτη σας επιπλέον με
          χαρτομάντηλο. </li>
      <li>Πετάξτε αμέσως το χαρτομάντηλο στον κάδο απορριμμάτων.</li>
      <li>Πλένετε τακτικά τα χέρια σας με σαπούνι και νερό (τουλάχιστον για 30
          δευτερόλεπτα – και τον αντίχειρα) ή χρησιμοποιείστε αλκοολούχο
          αντισηπτικό διάλυμα.</li>
      <div> <a href="https://youtu.be/3PmVJQUCm4E"> https://youtu.be/3PmVJQUCm4E </a></div>
      <li>Μην αγγίζετε τα μάτια, τη μύτη και το στόμα σας.</li>
      <li>Καθαρίζετε τακτικά το χώρο σας, τις επιφάνειες εργασίας καθώς και τα
          πόμολα με αραιωμένη χλωρίνη ή αντισηπτικό διάλυμα.</li>
      <li>Τηρείτε τις αποστάσεις και αποφεύγετε τον συγχρωτισμό</li>
      <li>Αερίζετε τους χώρους εργασίας επαρκώς (ανοιχτά παράθυρα, αποφυγή
          συγχρωτισμού).</li>
    </ul> 
