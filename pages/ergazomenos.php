      ...
      <ul class="nospace">
        <?php 
          ...
          if(!isset($_COOKIE[$cookie_name])) {        
              echo '<li><a style="color: #0026ff" href="login.html?header=ergazomenos.php" title="Σύνδεση">Σύνδεση <i class="fas fa-sign-in-alt"></i></a></li>';
              echo '<li><a style="color: #0026ff" href="register.html?header=ergazomenos.php" title="Εγγραφή">Εγγραφή <i class="fas fa-edit"></i></a></li>';
          } else {
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <h1>Εργαζόμενος</h1>
    <ul>
    <li><a href="dead_page.php">COVID-19 και Εργασία</a>
        <ul>
        <li><a href="adeia_eidikou_skopou.php"> Φόρμα για άδεια ειδικού σκοπού </a></li>
        <li><a href="dead_page.php?mid=1">Μετακινήσεις και απαραίτητα έγγραφα</a></li>
        </ul>
    </li>
    <li><a href="lista_adeiwn.php">Λίστα αδειών ειδικού σκοπού</a></li>
    <li><a href="dead_page.php?mid=2">Εργασιακά δικαιώματα</a></li>
    <li><a href="dead_page.php?mid=3">Κατάρτιση και σεμινάρια</a></li>
    <li><a href="dead_page.php?mid=4">Προκυρήξεις</a></li>
</ul>
    <div class="clear"></div>
  </main>
</div>
