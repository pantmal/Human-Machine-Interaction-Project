      ...
      <ul class="nospace">
        <?php 
          ...
          if(!isset($_COOKIE[$cookie_name])) {        
              echo '<li><a style="color: #0026ff" href="login.html?header=lista_ergazomenwn.php" title="Σύνδεση">Σύνδεση <i class="fas fa-sign-in-alt"></i></a></li>';
              echo '<li><a style="color: #0026ff" href="register.html?header=lista_ergazomenwn.php" title="Εγγραφή">Εγγραφή <i class="fas fa-edit"></i></a></li>';
          } else {
      ...
      <ul class="clear">
        ...
        <li class="active"><a class="drop" href="ergodotis.php">Εργοδότης</a>
          <ul>
            ...
            <li class="active"><a href="lista_ergazomenwn.php">Λίστα Εργαζομένων</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <?php
        ...
        if ($role!='ergodotis'){
          echo '<p>Πρέπει να είστε εργοδότης για να έχετε πρόσβαση σε αυτήν την σελίδα. Βεβαιωθείτε επίσης ότι έχετε συνδεθεί στην εφαρμογή.</p>';
        }else{
          ...
          if($rows == 0){
            echo '<p>Δεν υπάρχουν προς το παρόν εργαζόμενοι στην επιχείρηση σας.</p>';
          }else{
            ...
            for ($i = 0; $i < $rows; ++$i){
                ...
                echo '<td><a href="anastoli_symvasis.php?afm='.$afm.'" ><span>Δήλωση</span></a></li> </td>';    
